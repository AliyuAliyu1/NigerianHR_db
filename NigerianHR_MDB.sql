...
CREATE TABLE employees (
  ...
  CONSTRAINT training_sessions_fk FOREIGN KEY (attendance_ID) REFERENCES attendance(attendance_id),
  CONSTRAINT multiple_leaves_fk FOREIGN KEY (department_ID) REFERENCES departments(departments_id),
